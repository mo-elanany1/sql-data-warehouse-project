...
BEGIN
    ...
    DECLARE @proc_start     DATETIME = GETDATE();
    ...
    BEGIN TRY
        ...
        PRINT 'Total Duration (sec): ' + CAST(DATEDIFF(SECOND, @proc_start, GETDATE()) AS VARCHAR);
        PRINT '============================================================';
    ...
    BEGIN CATCH
        ...
        -- Re-raise the error so the caller knows the proc failed
        THROW;
